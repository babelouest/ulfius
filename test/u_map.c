...
START_TEST(test_u_map_get)
{
  ...
  ck_assert_ptr_eq(u_map_get(&map, "nope"), NULL);
  ck_assert_ptr_eq(u_map_get(NULL, "key"), NULL);
  ...
  ck_assert_ptr_eq(u_map_get_case(&map, "noPE"), NULL);
  ck_assert_ptr_eq(u_map_get_case(NULL, "keY"), NULL);
